...
const MainSlider = () => {
  return (<div className='myCarousel' >
    <Carousel interval={null} loop={true} fade>
     ...
     height="510"
    /> */}
        <div className='slider' style={{ background: `url(${Hero1})`, height: "100%", width: "100%", backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center 60%" }}>
          <div class="content">
            <div class="container">
      ...
      <Carousel.Item className='sliderOverlay'>
        {/* <img
          ...
          height="510"
        /> */}
        <div className='slider' style={{ background: `url(${Hero4})`, height: "100%", width: "100%", backgroundSize:"cover",backgroundRepeat:"no-repeat",backgroundPosition:"center 15%" }}>
          <div class="content">
            <div class="container">
              <div class="content-box">
                <h2 className="animate__animated animate__fadeInDown">Storytelling is a medium<br /> for social change</h2>
