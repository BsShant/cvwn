...
export default function MenuToggle() {
  return (
    ...
    <button class=" myButton" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><span className="canvasToggler"><i className='fas fa-bars'/> </span></button>
...
<div class="offcanvas offcanvas-end"  id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <div className="collapse navbar-collapse "  id="offcanvasRight ">
      ...
      <Link  className="nav-link" id="offcanvasRight" to='/'  aria-expanded="false" >
            Home
          </Link>
    </div>
    <div className="nav-item dropdown">
    <Link  className="nav-link" id="offcanvasRight" to='/about'  aria-expanded="false" >
            About
          </Link>
    </div>
    <div className="nav-item dropdown">
          <a className="nav-link " href="#" id="offcanvasRight" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          Project
          </a>
    ...
    <div className="nav-item dropdown">
    <Link  className="nav-link" id="offcanvasRight" to='/events'  aria-expanded="false" >
           Event
    </Link>
    </div>
    <div className="nav-item dropdown">
    ...
    <div className="nav-item dropdown">
    <Link  className="nav-link" id="offcanvasRight" to='/contact'  aria-expanded="false" >
           Contact
    </Link>
    </div>
  </div>
